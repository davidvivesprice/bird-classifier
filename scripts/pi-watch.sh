#!/bin/bash
# REPO COPY (added 2026-07-17): canonical installed copy is /Users/vives/bin/pi-watch.sh,
# referenced by launchd. This copy exists so the breaker/monitor/backup
# logic is versioned; keep both in sync when editing (cp to /Users/vives/bin/pi-watch.sh).
