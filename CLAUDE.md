...
>
> Cross-cutting fixes (anything that benefits both sides) flow via patches in `docs/working/progress/cross-claude-comms.md` (historical two-Claude workflow; the file remains as the patch log).
>
