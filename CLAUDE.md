...
>
> The two-Claude patch workflow (`docs/working/progress/cross-claude-comms.md`) is historical — one operator owns both repos now and cross-cutting fixes are cherry-picked directly.
>
