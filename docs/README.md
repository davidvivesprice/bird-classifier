...
The reference **book** for the Pi-side observatory lives outside this repo, at `~/docs/bird-observatory-pi/` — chapters 00 through 12 plus that book's own README. See [`~/docs/bird-observatory-pi/README.md`](file:///Users/vives/docs/bird-observatory-pi/README.md).
